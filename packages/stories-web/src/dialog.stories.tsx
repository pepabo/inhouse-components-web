...
import { useStyleBase } from './components/styleBase'
...
const DialogButton: FC<DialogButtonProps> = ({ modifiers, onClick, children }) => {
  const styleBase = useStyleBase();

  return (
    <button
      className={`${styleBase}-button ${modifiers}`}
      onClick={onClick}
    >
...
const renderButtons = (
  ...
  const primaryButton = (
    <DialogButton
      modifiers="-appearance-filled -color-interactive"
